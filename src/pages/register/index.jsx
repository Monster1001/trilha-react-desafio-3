...
import { Container, Title, Column, TitleLogin, SubtitleLogin,  CriarText, Row, Wrapper, JaTenhoContaText, FazerLoginText } from './styles';
        ...
        <Container>
            ...
            <Column>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Input placeholder="E-mail" leftIcon={<MdEmail />} name="E-mailCadastro"  control={control} />
                ...
                <Row>
                    ...
                    <a href="/login" style={{ textDecoration: "none",}}><FazerLoginText>Fazer login</FazerLoginText></a>
            </Column>
        </Container>
    </>)
}
